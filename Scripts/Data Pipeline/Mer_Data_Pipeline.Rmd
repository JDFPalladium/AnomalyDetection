...
# edit this code
# group by facility, age, sex, and indicator, and then summarize qtr 1 (before pivot); drop status HIV
mer_png_tn <- mer_png_tn %>% group_by(facility, indicator) %>% 
...
cols_to_keep <- c(6,10,14,18:36)
mer_png_full_processed <- mer_png_full_processed[, cols_to_keep]
