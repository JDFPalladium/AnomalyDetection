...
mer_png_sex$facility <- as.factor(mer_png_sex$facility)
mer_png_sex$indicator <- as.factor(mer_png_sex$indicator)
mer_png_sex$sex <- as.factor(mer_png_sex$sex)

mer_png_sex <- mer_png_sex %>% group_by(facility, indicator, sex) %>% 
