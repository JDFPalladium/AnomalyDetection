...
# values are NA if the facility did not report on that indicator for any of the quarters
# values are 0 for cells that were blank in the panorama_raw file

#panorama_processed[is.na(panorama_processed)] <- 0
write.csv(panorama_processed, file = "panorama_processed.csv")
```
